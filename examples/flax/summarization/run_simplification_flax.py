...
class DataTrainingArguments:
    ...
    src_column: Optional[str] = field(
        default=None,
        metadata={"help": "The name of the column in the datasets containing the source (complex) texts (for simplification)."},
    )
    dst_column: Optional[str] = field(
        default=None,
        metadata={"help": "The name of the column in the datasets containing the destination (simple) texts (for simplification)."},
    )
...
def main():
    ...
    send_example_telemetry("run_simplification", model_args, data_args, framework="flax")
